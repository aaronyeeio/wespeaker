...
config=conf/samresnet100_50.yaml
exp_dir=exp/samresnet100_50
gpus="[2,3,4,5,6]"
num_avg=1
checkpoint=exp/samresnet100_50/models/model_0.pt
...
lm_config=conf/samresnet100_lm.yaml
...
if [ ${stage} -le 9 ] && [ ${stop_stage} -ge 9 ]; then
  ...
  bash run_samresnet100_50.sh --stage 3 --stop_stage 8 \
      --data ${data} \
      --data_type ${data_type} \
      --config ${lm_config} \
      --exp_dir ${lm_exp_dir} \
