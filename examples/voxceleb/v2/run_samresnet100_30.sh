...
config=conf/samresnet100_30.yaml
exp_dir=exp/samresnet100_30
gpus="[2,3,4,5,6]"
num_avg=1
checkpoint=exp/samresnet100_30/models/model_3.pt
...
if [ ${stage} -le 9 ] && [ ${stop_stage} -ge 9 ]; then
  ...
  bash run_samresnet100_30.sh --stage 3 --stop_stage 8 \
      --data ${data} \
      --data_type ${data_type} \
      --config ${lm_config} \
      --exp_dir ${lm_exp_dir} \
